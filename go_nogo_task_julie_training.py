...
class go_nogo_phase1(object):
    def __init__(self, **kwargs):  # name and session_info should be provided as kwargs
        ...
        # standby is the initial state, then trigger appropriate transitions depending on the type of trial
        # temp# are temporary states (used as a placeholders for transitions to other states)
        ...
        # normal ITI length of 3s +/- 1s (variable)
        # nogo trials: 180 degree drifting gratings presentation for 3s and no reward is available, if any lick is
        # detected after the 2nd second, it will consider it as False Alarm trial with longer ITI of 6.5s +/- 1s
        ...
        self.states = [
            ...
            # after initiation, it will stay in this state for 1s (lockout_length), then transition to reward_available
    ...
    def run_go(self):
        ...
        if self.state == "standby":
            ...
            self.pump.reward("1", self.session_info["solenoid_blink_duration"], 0.01, 4)
