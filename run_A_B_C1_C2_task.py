...
date: 2023-06-12
name: run_A_B_C1_C2_task.py
goal: running the A_B_C1_C2task
"""
import random
...
from A_B_C1_C2_task import A_B_C1_C2_task
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/A_B_C1_C2_task/session_info/'
    ...
    task = A_B_C1_C2_task(name="A_B_C1_C2_task", session_info=session_info)
