...
#liquid_SA_task_dual_lever.task

#!/usr/bin/env -S ipython3 -i
# liquid_SA_task_dual_lever.py
"""
...
from liquid_SA_task_dual_lever import LiquidSATaskDualLever
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/liquid_SA_task_dual_lever/session_info/'
    ...
    task = LiquidSATaskDualLever(name="liquid_SA_task_dual_lever", session_info=session_info)
