...
#run_remi_vs_liquid_lick_choice_task.task

#!/usr/bin/env -S ipython3 -i
# run_remi_vs_liquid_lick_choice_task.py
"""
author: Mitch Farrell
date: 2024-03-11
name: run_remi_vs_liquid_lick_choice_task.py
goal: running the remi_vs_liquid_lick_choice_task
"""
import random
...
from remi_vs_liquid_lick_choice_task import RemiVSLiquidLickChoiceTask
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/remi_vs_liquid_lick_choice_task/session_info/'
    ...
    task = RemiVSLiquidLickChoiceTask(name="remi_vs_liquid_lick_choice_task", session_info=session_info)
    ...
    if random_start > 0: # and random_start < 0.8
        task.start_in_free_choice()
    # elif random_start > 0.8 and random_start <= 0.9:
    #     task.start_in_remi_forced()
    # else:
    #     task.start_in_liquid_forced()
