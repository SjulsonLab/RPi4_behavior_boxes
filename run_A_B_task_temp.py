...
date: 2023-05-16
name: run_A_B_task.py
goal: running the A_B_task
"""
import random
...
from A_B_task_temp import A_B_task
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/A_B_task/session_info/'
    ...
    task = A_B_task(name="A_B_task_temp", session_info=session_info)
