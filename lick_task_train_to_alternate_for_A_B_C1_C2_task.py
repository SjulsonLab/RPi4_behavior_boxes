...
date: 2023-06-12
name: lick_task_train_to_alternate_for_A_B_C1_C2_task.py
"""
import importlib
...
class SelfAdminTaskLeftActions(object):
        ...
        if self.state == "standby":
            ...
            if self.event_name == "left_entry":
                ...
                if lever_pressed_dt >= self.lever_press_interval:
                    ...
                    #this is the alternating task; update this first; then update the ivsa task code from the version that contains timeouts
