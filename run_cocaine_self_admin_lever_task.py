...
#run_cocaine_self_admin_lever_task.py
...
date: 2024-01-17
name: run_cocaine_self_admin_lever_task.py
"""
import random
...
from cocaine_self_admin_lever_task import CocaineSelfAdminLeverTask
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/cocaine_self_admin_lever_task/session_info/'
    ...
    task = CocaineSelfAdminLeverTask(name="cocaine_self_admin_lever_task", session_info=session_info)
