...
date: 2023-06-12
name: run_lick_task_train_to_alternate_for_A_B_C1_C2_task.py
goal: running the lick_task_train_to_alternate_for_A_B_C1_C2_task
"""
import random
...
from self_admin_task_left_actions import SelfAdminTaskLeftActions
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/self_admin_task_left_actions/session_info/'
    ...
    task = SelfAdminTaskLeftActions(name="self_admin_task_left_actions", session_info=session_info)
