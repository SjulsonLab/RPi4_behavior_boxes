...
class go_nogo_reversal(object):
    ...
    def _close_visualstim(self, object_label, visualstim_object):
        ...
        visualstim_object : object or None
            Visual stimulus object from behavbox_DT. No shape or unit conventions apply.
    ...
    def emergency_stop_all_cues(self):
        ...
        # In reversal, the go/no-go stimulus identities are switched, so shut down both cues.
