...
#run_opioid_forage_task_phase_2

#!/usr/bin/env -S ipython3 -i
# run_opioid_forage_task_phase_2.py
"""
author: Mitch Farrell
date: 2024-05-01
name: run_opioid_forage_task_phase_2.py
goal: running the opioid_forage_task_phase_2
"""
import random
...
from opioid_forage_task_phase_2 import OpioidForageTaskPhase2
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/opioid_forage_task_phase_2/session_info/'
    ...
    task = OpioidForageTaskPhase2(name="opioid_forage_task_phase_2", session_info=session_info)
