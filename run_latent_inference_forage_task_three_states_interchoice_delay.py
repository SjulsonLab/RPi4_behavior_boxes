...
#run_latent_inference_forage_task_three_states_interchoice_delay.py
...
date: 2023-11-21
name: run_latent_inference_forage_task_three_states_interchoice_delay.py
"""
import random
...
from latent_inference_forage_task_three_states_interchoice_delay import LatentInferenceForageTaskThreeStatesInterchoiceDelay
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/latent_inference_forage_task_three_states_interchoice_delay/session_info/'
    ...
    task = LatentInferenceForageTaskThreeStatesInterchoiceDelay(name="latent_inference_forage_task_three_states_interchoice_delay", session_info=session_info)
