...
from go_nogo_task_phase3_final import go_nogo_phase3
...
if __name__ == "__main__":
    try:
        ...
        training_phase = input("Enter training_phase (allgo or phase3):\n")
        ...
        task = go_nogo_phase3(name="go_nogo_task_phase3_final", session_info=session_info)
        ...
        if training_phase == "allgo":
            while training_phase == "allgo":
                task.bait_phase3()
                if task.deliver_reward == "":  # start phase3 of training
