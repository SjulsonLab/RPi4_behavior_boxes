...
date: 2023-01-17
name: run_cocaine_BE_lever_task.py
"""
import random
...
from cocaine_BE_lever_task import CocaineBELeverTask
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/cocaine_BE_lever_task/session_info/'
    ...
    task = CocaineBELeverTask(name="cocaine_BE_lever_task", session_info=session_info)
