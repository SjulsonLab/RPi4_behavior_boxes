...
fake_session_info["datetime"] = (
    fake_session_info["date"] + "_" + fake_session_info["time"]
)
fake_session_info["basename"] = (
    fake_session_info["mouse_name"] + "_" + fake_session_info["datetime"]
)
fake_session_info["box_name"] = socket.gethostname()
fake_session_info["dir_name"] = (
    fake_session_info["basedir"]
    + "/"
    + fake_session_info["mouse_name"]
    + "_"
    + fake_session_info["datetime"]
)
...
fake_session_info["vis_gratings"] = [
