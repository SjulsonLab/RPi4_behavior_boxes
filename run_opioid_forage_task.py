...
date: 2023-04-26
name: run_opioid_forage_task.py
goal: running the opioid_forage_task
"""
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/opioid_forage_task/session_info/'
    ...
    task = OpioidForageTask(name="opioid_forage_task", session_info=session_info)
