...
# python3: C1_C2_task_xreward_switch.py
"""
author: Mitch Farrell
date: 2023-05-15
name: C1_C2_task_xreward_switch.py
"""
import importlib
...
class C1_C2_task_xreward_switch(object):
    ...
    def ContextC1_stim(self):
        while self.state == 'ContextC1':
            self.box.visualstim.myscreen.display_greyscale(self.session_info['gray_level']['default'])
            time.sleep(1)

    def ContextC2_stim(self):
        while self.state == 'ContextC2':
            self.box.visualstim.myscreen.display_greyscale(self.session_info['gray_level']['default'])
            time.sleep(1)
    ...
    def switch_to_ContextC1_C2(self):
        if self.prior_two_trials_list[0] == 'ContextC1' and self.prior_two_trials_list[1] == 'ContextC1':
            self.switch_to_ContextC2()
        elif self.prior_two_trials_list[0] == 'ContextC2' and self.prior_two_trials_list[1] == 'ContextC2':
