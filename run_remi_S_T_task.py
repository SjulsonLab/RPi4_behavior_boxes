...
from remi_S_T_task import remi_S_T_task
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/remi_S_T_task/session_info/'
    ...
    task = remi_S_T_task(name="remi_S_T_task", session_info=session_info)
