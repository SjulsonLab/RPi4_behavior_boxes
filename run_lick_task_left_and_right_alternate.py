...
#run_lick_task_left_and_right_alternate.task

#!/usr/bin/env -S ipython3 -i
# run_lick_task_left_and_right_alternate.py
"""
author: Mitch Farrell
date: 2023-06-30
name: run_lick_task_left_and_right_alternate.py
"""
import random
...
from lick_task_left_and_right_alternate import LickTaskLeftandRightAlternate
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/lick_task_left_and_right_alternate/session_info/'
    ...
    task = LickTaskLeftandRightAlternate(name="lick_task_left_and_right_alternate", session_info=session_info)
