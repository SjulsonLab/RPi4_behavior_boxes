...
class LatentInferenceForageTaskThreeStatesInterchoiceDelayOneDarkPer(object):
    ...
    def __init__(self, **kwargs):  # name and session_info should be provided as kwargs
        ...
        self.transitions = [
            ...
            ['end_task', ['dark_period', 'left_patch','right_patch'], 'standby']]
    ...
    def exit_standby(self):
        ...
        self.next_dark_time = self.end_dark_time + 1740
    ...
    def enter_dark_period(self):
        ...
        self.box.cueLED1.off()
        self.box.cueLED2.off()
        self.current_dark_period = 120
        time.sleep(self.current_dark_period)
        self.next_dark_time = time.time() + 3600 #large value to prevent another dark period from arising
