...
#run_latent_inference_forage_task_three_states.py
...
date: 2023-10-26
name: run_latent_inference_forage_task_three_states.py
"""
import random
...
from latent_inference_forage_task_three_states import LatentInferenceForageTaskThreeStates
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/latent_inference_forage_task_three_states/session_info/'
    ...
    task = LatentInferenceForageTaskThreeStates(name="latent_inference_forage_task_three_states", session_info=session_info)
