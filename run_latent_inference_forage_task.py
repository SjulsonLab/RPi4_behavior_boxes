...
from latent_inference_forage_task import LatentInferenceForageTask
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/latent_inference_forage_task/session_info/'
    ...
    task = LatentInferenceForageTask(name="latent_inference_forage_task", session_info=session_info)
