...
#run_latent_inference_forage_task_three_states_interchoice_delay_one_dark_per.py
...
date: 2023-11-21
name: run_latent_inference_forage_task_three_states_interchoice_delay_one_dark_per.py
"""
import random
...
from latent_inference_forage_task_three_states_interchoice_delay_one_dark_per import LatentInferenceForageTaskThreeStatesInterchoiceDelayOneDarkPer
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/latent_inference_forage_task_three_states_interchoice_delay_one_dark_per/session_info/'
    ...
    task = LatentInferenceForageTaskThreeStatesInterchoiceDelayOneDarkPer(name="latent_inference_forage_task_three_states_interchoice_delay_one_dark_per", session_info=session_info)
