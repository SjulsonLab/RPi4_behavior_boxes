...
date: 2023-05-16
name: run_C1_C2_task.py
goal: running the C1_C2_task
"""
import random
...
from C1_C2_task import C1_C2_task
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/C1_C2_task/session_info/'
    ...
    task = C1_C2_task(name="C1_C2_task", session_info=session_info)
