...
date: 2024-02-06
name: run_headfixed_habituation.py
...
from headfixed_2FC import Headfixed2FC
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/headfixed_2FC/session_info'
    ...
    # reward deck and draw card to randomize the reward amount from task_information_habituation.py
    from task_information_headfixed_2FC import TaskInformation
    task_information = TaskInformation()
    # print("Imported task_information_headfixed: " + str(task_information.name))
    task = Headfixed2FC(name="headfixed_2FC", session_info=session_info)
