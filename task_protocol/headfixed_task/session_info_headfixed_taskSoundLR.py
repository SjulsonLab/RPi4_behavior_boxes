...
session_info['extra_reward'] = False
session_info['extra_reward_size'] = 0
...
session_info['fraction'] = 0.5     # 0.3, 0.5,0.7,1 # free choice fraction 1 for all free choice
session_info['phase'] = 'forced_choice' # 'forced_choice', 'sine_reward'
session_info['cue_time'] = 10        # second
session_info['initiation_time'] = 10 # second
