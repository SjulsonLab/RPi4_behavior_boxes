...
session_info['config'] = 'headfixedHabituation'
...
session_info['initiation_time'] = 1 # second


if session_info['treadmill']:
    session_info['treadmill_setup']['distance_cue'] = 0  # cm
    session_info['treadmill_setup']['distance_initiation'] = 0  # cm
else:
