...
session_info['manual_date'] = '2024-02-06'
...
session_info['phase'] = 'forced_choice' # 'forced_choice', 'sine_reward'
session_info['cue_time'] = 5      # second
session_info['initiation_time'] = 2 # second
session_info['initiation_start_duration']  = 0.5 # second not licking to initiate

if session_info['treadmill']:
    session_info['treadmill_setup']['distance_cue'] = 15  # cm
    session_info['treadmill_setup']['distance_initiation'] = 10  # cm
else:
    session_info['treadmill_setup'] = None

session_info['error_repeat'] = False
...
if solenoid_coeff:
    ...
    session_info["calibration_coefficient"]['1'] = [7.368, 0]  # highest power first
    session_info["calibration_coefficient"]['2'] = [7.368, 0]
    session_info["calibration_coefficient"]['3'] = [7.368, 0.0]
    session_info["calibration_coefficient"]['4'] = [7.368, 0.0]
