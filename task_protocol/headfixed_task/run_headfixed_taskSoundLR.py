...
date: 2024-02-25
name: run_headfixed_taskSoundLR.py
goal: to cue with sound and LED
description:
"""
import random
import numpy as np
...
from headfixed_taskSoundLR import HeadfixedTaskSoundLR
...
try:
    ...
    from task_information_taskSoundLR import TaskInformation
    task_information = TaskInformation()
    # print("Imported task_information_headfixed: " + str(task_information.name))
    task = HeadfixedTaskSoundLR(name="headfixed_taskSoundLR", session_info=session_info)
