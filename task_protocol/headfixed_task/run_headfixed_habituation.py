...
from headfixed_habituation import HeadfixedHabituation
...
try:
    ...
    from task_information_habituation import TaskInformation
    task_information = TaskInformation()
    # print("Imported task_information_headfixed: " + str(task_information.name))
    task = HeadfixedHabituation(name="headfixed_habituation", session_info=session_info)
