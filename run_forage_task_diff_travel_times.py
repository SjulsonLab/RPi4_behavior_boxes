...
from forage_task_diff_travel_times import ForageTask
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/forage_task_diff_travel_times/session_info/'
    ...
    task = ForageTask(name="forage_task_diff_travel_times", session_info=session_info)
