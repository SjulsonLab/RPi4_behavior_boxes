...
date: 2023-05-16
name: run_A_B_task_bias.py
goal: running the A_B_task_bias
"""
import random
...
from A_B_task_bias import A_B_task_bias
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/A_B_task_bias/session_info/'
    ...
    task = A_B_task_bias(name="A_B_task_bias", session_info=session_info)
