...
# python3: remi_self_admin_lick_task_reinstatement.py
"""
author: Mitch Farrell
date: 2023-06-12
name: remi_self_admin_lick_task_reinstatement.py
"""
import importlib
...
class remi_self_admin_lick_task_reinstatement(object):
    ...
    def reward(self):  # prototype mouse weight equals 30
        infusion_duration = (self.session_info['weight'] * 0)
    ...
    def fill_cath(self):
        ...
        logging.info(";" + str(time.time()) + ";[reward];catheter_not_filled;")
