...
from switch_affect_task import SwitchAffectTask
import random
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/switch_affect_task/session_info/'
    ...
    if random.uniform(0,1) > 0.5:
        task.start_in_right_equiv()
    else:
        task.start_in_right_diff()
