...
def clear_behavior_cues_for_baseline(task):
    ...
    Inputs
    ------
    task : go_nogo_reversal-like object
...
def run_timed_baseline(
    ...
    try:
        ...
        log_session_event("baseline_interrupted", time_fn(), session_info, write_marker_csv=True)
    ...
    if baseline_completed:
        log_session_event("baseline_completed", baseline_end_time, session_info, write_marker_csv=True)
