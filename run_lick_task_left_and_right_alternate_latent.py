...
#run_lick_task_left_and_right_alternate_latent.task

#!/usr/bin/env -S ipython3 -i
# run_lick_task_left_and_right_alternate_latent.py
"""
author: Mitch Farrell
date: 2023-08-15
name: run_lick_task_left_and_right_alternate_latent.py
"""
import random
...
from lick_task_left_and_right_alternate_latent import LickTaskLeftandRightAlternateLatent
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/lick_task_left_and_right_alternate_latent/session_info/'
    ...
    task = LickTaskLeftandRightAlternateLatent(name="lick_task_left_and_right_alternate_latent", session_info=session_info)
