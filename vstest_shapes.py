...
options_go = {"angle": 90, "spac_freq": 0.1, "temp_freq": 0.3, "duration": 3, "percent_diameter": 30, "percent_center_left": 50, "percent_center_top": 50, "background": 0, "waveform": rpg.SQUARE}
rpg.build_masked_grating("~/first_grating_go_shape.dat", options_go)

# Define the "No-Go" stimulus
options_nogo = {"angle": 180, "spac_freq": 0.1, "temp_freq": 0.3, "duration": 3, "percent_size": 30, "percent_center_left": 50, "percent_center_top": 50,  "background": 255, "waveform": rpg.SQUARE}
