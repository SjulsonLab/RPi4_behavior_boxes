...
options_go = {"angle": 90, "spac_freq": 0.025, "temp_freq": 0.0001, "duration": 3,  "contrast": 1, "percent_diameter": 30, "percent_center_left": 50, "percent_center_top": 50, "background": 0, "waveform": rpg.SQUARE}
rpg.build_grating("~/first_grating_go_ret.dat", options_go)

# Define the "No-Go" stimulus
options_nogo = {"angle": 180, "spac_freq": 0.1, "temp_freq": 0.3, "duration": 3, "contrast": 0, "percent_diameter": 50, "percent_center_left": 50, "percent_center_top": 50,  "colormode": 0, "background": 255}
