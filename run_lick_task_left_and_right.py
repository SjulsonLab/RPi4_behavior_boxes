...
date: 2023-05-15
name: run_lick_task_left_and_right.py
"""
import random
...
from lick_task_left_and_right import LickTaskLeftandRight
...
try:
    ...
    task = LickTaskLeftandRight(name="lick_task_left_and_right", session_info=session_info)
