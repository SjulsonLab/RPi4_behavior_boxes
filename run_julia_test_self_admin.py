...
from julia_test_self_admin import CocaineSelfAdminLeverTask
...
try:
    ...
    session_info_path = '/home/pi/experiment_info/julia_test_self_admin/session_info/'
    ...
    task = CocaineSelfAdminLeverTask(name="julia_test_self_admin", session_info=session_info)
