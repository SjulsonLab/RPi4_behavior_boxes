...
############################### Phase 1 first day ###############################
#################################################################################
class go_nogo_phase1_first_day(object):
    def __init__(self, **kwargs):  # name and session_info should be provided as kwargs
...
#################################################################################
################### Phase 1 lick_evoked reward delivery #########################
#################################################################################
class go_nogo_phase1_lick_evoked_reward(object):
    def __init__(self, **kwargs):  # name and session_info should be provided as kwargs
...
#################################################################################
################### Phase1_trial_initiation #########################
#################################################################################
class go_nogo_phase1_trial_initiation(object):
    def __init__(self, **kwargs):  # name and session_info should be provided as kwargs
        ...
        self.states = [
            ...
            # initiation assessment state: determine whether there is no lick for 1s before starting new trial
            Timeout(
                name="initiation_assessment",
                on_enter=["enter_initiation_assessment"],
                on_exit=["exit_initiation_assessment"],
            ),
            ###################################### end of states for nogo trials ######################################
            ###########################################################################################################
        ]
        ...
        self.transitions = [
            ...
            ["start_punishment_iti", "assessment", "punishment_iti"],
            ["start_extra_iti_punishment", "punishment_iti", "extra_iti"],
            ["start_initiation_assessment", "extra_iti", "initiation_assessment"],
            ["return_to_standby", "initiation_assessment", "standby"],
        ]
