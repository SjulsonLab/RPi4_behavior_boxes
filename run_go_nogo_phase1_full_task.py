...
from go_nogo_task import go_nogo_phase1_trial_initiation
...
if __name__ == "__main__":
    try:
        ...
        task = go_nogo_phase1_trial_initiation(name="go_nogo_phase1_lick_evoked_reward", session_info=session_info)
